...
public interface IMqttAsyncClient {
     ...
     *
     * @param options     a set of connection parameters that override the defaults.
     * @param userContext optional object for used to pass context to the callback. Use null
     *                    if not required.
     * @param callback    optional listener that will be notified when the connect
     *                    completes. Use null if not required.
     * @return token used to track and wait for the connect to complete. The token
     ...
     *
     * @param disconnectTimeout the amount of time in milliseconds to allow send disconnect packet
     *                          to server.
     * @throws MqttException if any unexpected error
     * @since 0.4.1
     */
    ...
    public IMqttToken subscribe(String[] topicFilters, int[] qoss, IMqttMessageListener[] messageListeners)
            throws MqttException;
     ...
     *
     * @param topicFilters one or more topics to unsubscribe from. Each topicFilter must
     ...
     * @param qos         the Quality of Service to deliver the message at. Valid values are
     *                    0, 1 or 2.
     * @param retained    whether or not this message should be retained by the server.
     * @param userContext optional object used to pass context to the callback. Use null if
     *                    not required.
     * @param callback    optional listener that will be notified when message delivery hsa
     ...
     * @throws MqttException            for other errors encountered while publishing the message. For
     ...
     * @param userContext optional object used to pass context to the callback. Use null if
     *                    not required.
     * @param callback    optional listener that will be notified when message delivery has
     *                    completed to the requested quality of service.
     * @return token used to track and wait for the publish to complete. The token
     * will be passed to callback methods if set.
     * @throws MqttPersistenceException when a problem occurs storing the message
    ...
    public IMqttToken unsubscribe(String[] topicFilters, Object userContext, MqttActionListener callback) throws MqttException;
}
