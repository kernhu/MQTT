...
import org.cion.eclipse.mqtt5.client.internal.ConnectActionListener;
import org.cion.eclipse.mqtt5.client.internal.DisconnectedMessageBuffer;
import org.cion.eclipse.mqtt5.client.internal.MqttConnectionState;
import org.cion.eclipse.mqtt5.client.internal.MqttSessionState;
import org.cion.eclipse.mqtt5.client.internal.NetworkModule;
import org.cion.eclipse.mqtt5.client.internal.NetworkModuleService;
import org.cion.eclipse.mqtt5.client.logging.Logger;
import org.cion.eclipse.mqtt5.client.logging.LoggerFactory;
import org.cion.eclipse.mqtt5.client.persist.MemoryPersistence;
import org.cion.eclipse.mqtt5.client.persist.MqttDefaultFilePersistence;
import org.cion.eclipse.mqtt5.client.util.Debug;
import org.cion.eclipse.mqtt5.common.ExceptionHelper;
...
import org.cion.eclipse.mqtt5.common.packet.MqttAuth;
import org.cion.eclipse.mqtt5.common.packet.MqttDataTypes;
import org.cion.eclipse.mqtt5.common.packet.MqttDisconnect;
import org.cion.eclipse.mqtt5.common.packet.MqttProperties;
import org.cion.eclipse.mqtt5.common.packet.MqttPublish;
import org.cion.eclipse.mqtt5.common.packet.MqttReturnCode;
import org.cion.eclipse.mqtt5.common.packet.MqttSubscribe;
import org.cion.eclipse.mqtt5.common.packet.MqttUnsubscribe;
import org.cion.eclipse.mqtt5.common.util.MqttTopicValidator;
...
public class MqttAsyncClient implements MqttClientInterface, IMqttAsyncClient {
     ...
     *
     * @param serverURI the address of the server to connect to, specified as a URI. Can
     *                  be overridden using
     *                  {@link MqttConnectionOptions#setServerURIs(String[])}
     * @param clientId  a client identifier that is unique on the server being connected
     *                  to
     ...
     * @param persistence     the persistence class to use to store in-flight message. If null
     *                        then the default persistence mechanism is used
     * @param pingSender      the {@link MqttPingSender} Implementation to handle timing and
     *                        sending Ping messages to the server.
     * @param executorService used for managing threads. If null then a newScheduledThreadPool
     *                        is used.
     * @throws IllegalArgumentException if the URI does not start with "tcp://", "ssl://" or "local://"
     * @throws IllegalArgumentException if the clientId is null or is greater than 65535 characters in
     *                                  length
     ...
     * @param options the {@link MqttConnectionOptions} for the connection.
     ...
     *
     * @see
     * org.cion.eclipse.mqtt5.client.IMqttAsyncClient#connect(java.lang.Object,
     * org.cion.eclipse.mqtt5.client.MqttActionListener)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.cion.eclipse.mqtt5.client.IMqttAsyncClient#connect()
     */
    @Override
     ...
     *
     * @see
     * org.cion.eclipse.mqtt5.client.IMqttAsyncClient#connect(org.eclipse.paho.
     ...
     *
     * @see
     * org.cion.eclipse.mqtt5.client.IMqttAsyncClient#disconnect(java.lang.Object,
     * org.cion.eclipse.mqtt5.client.MqttActionListener)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.cion.eclipse.mqtt5.client.IMqttAsyncClient#disconnect()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.cion.eclipse.mqtt5.client.IMqttAsyncClient#disconnect(long)
     */
    @Override
     ...
     *
     * @see org.cion.eclipse.mqtt5.client.IMqttAsyncClient#disconnect(long,
     * java.lang.Object, org.cion.eclipse.mqtt5.client.MqttActionListener, int,
     * org.cion.eclipse.mqtt5.common.packet.MqttProperties)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.cion.eclipse.mqtt5.client.IMqttAsyncClient#disconnectForcibly()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.cion.eclipse.mqtt5.client.IMqttAsyncClient#disconnectForcibly(long)
     */
    @Override
     ...
     *
     * @see org.cion.eclipse.mqtt5.client.IMqttAsyncClient#disconnectForcibly(long,
     * long, int, org.cion.eclipse.mqtt5.common.packet.MqttProperties)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.cion.eclipse.mqtt5.client.IMqttAsyncClient#isConnected()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.cion.eclipse.mqtt5.client.IMqttAsyncClient#getClientId()
     */
    @Override
     ...
     *
     * @see
     * org.cion.eclipse.mqtt5.client.IMqttAsyncClient#setClientId(java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.cion.eclipse.mqtt5.client.IMqttAsyncClient#getServerURI()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.cion.eclipse.mqtt5.client.IMqttAsyncClient#getCurrentServerURI()
     */
    @Override
     ...
     *
     * @see
     * org.cion.eclipse.mqtt5.client.IMqttAsyncClient#checkPing(java.lang.Object,
     * org.cion.eclipse.mqtt5.client.MqttActionListener)
     */
    @Override
     ...
     *
     * @see
     * org.cion.eclipse.mqtt5.client.IMqttAsyncClient#subscribe(java.lang.String,
     * int, java.lang.Object, org.cion.eclipse.mqtt5.client.MqttActionListener)
     */
    @Override
    ...
    @Override
    public IMqttToken subscribe(String[] topicFilters, int[] qoss, IMqttMessageListener[] messageListeners) throws MqttException {
        return this.subscribe(topicFilters, qoss, null, null, messageListeners);
    }
    /**********************************************************************************************************/
    /**********************************************************************************************************/
    /**********************************************************************************************************/
    ...
    public IMqttToken subscribe(String[] topicFilters, int[] qos, Object userContext, MqttActionListener callback,
        ...
        for (int i = 0; i < topicFilters.length; ++i) {
            ...
            if (messageListeners == null || messageListeners[i] == null) {
                ...
                this.comms.setMessageListener(0, topicFilters[i], messageListeners[i]);
            }
        }
     ...
     *
     * @see
     * org.cion.eclipse.mqtt5.client.IMqttAsyncClient#subscribe(org.eclipse.paho.
     ...
     * @throws MqttException
     */
    private IMqttToken subscribeBase(String[] topicFilters, int[] qos, Object userContext, MqttActionListener callback)
            throws MqttException {
        final String methodName = "subscribe";
     ...
     * mqttv5.common.MqttSubscription, java.lang.Object,
     * org.cion.eclipse.mqtt5.client.MqttActionListener,
     * org.cion.eclipse.mqtt5.client.IMqttMessageListener,
     * org.cion.eclipse.mqtt5.common.packet.MqttProperties)
     */
    @Override
     ...
     * java.lang.Object, MqttActionListener)
     */
    @Override
    ...
    public IMqttToken unsubscribe(String[] topicFilters, Object userContext, MqttActionListener callback)
            throws MqttException {
        return unsubscribe(topicFilters, userContext, callback, new MqttProperties());
    }
     ...
     *
     * @see
     * org.cion.eclipse.mqtt5.client.IMqttAsyncClient#unsubscribe(java.lang.String)
     */
    @Override
     ...
     * @see
     * org.cion.eclipse.mqtt5.client.IMqttAsyncClient#unsubscribe(java.lang.String[
     * ], java.lang.Object, org.cion.eclipse.mqtt5.client.MqttActionListener,
     * org.cion.eclipse.mqtt5.common.packet.MqttProperties)
     */
    @Override
    public IMqttToken unsubscribe(String[] topicFilters, Object userContext, MqttActionListener callback,
     ...
     *
     * @see
     * org.cion.eclipse.mqtt5.client.IMqttAsyncClient#setCallback(org.eclipse.paho.
     ...
     * (non-Javadoc)
     *
     * @see org.cion.eclipse.mqtt5.client.IMqttAsyncClient#setManualAcks(boolean)
     */
    @Override
     ...
     *
     * @see
     * org.cion.eclipse.mqtt5.client.IMqttAsyncClient#messageArrivedComplete(int,
     * int)
     */
    @Override
     ...
     *
     * @see
     * org.cion.eclipse.mqtt5.client.IMqttAsyncClient#getPendingTokens()
     */
    @Override
     ...
     *
     * @see
     * org.cion.eclipse.mqtt5.client.IMqttAsyncClient#publish(java.lang.String,
     ...
     * @see
     * org.cion.eclipse.mqtt5.client.IMqttAsyncClient#publish(java.lang.String,
     * org.cion.eclipse.mqtt5.common.MqttMessage)
     */
    @Override
     ...
     * @see
     * org.cion.eclipse.mqtt5.client.IMqttAsyncClient#publish(java.lang.String,
     * org.cion.eclipse.mqtt5.common.MqttMessage, java.lang.Object,
     * org.cion.eclipse.mqtt5.client.MqttActionListener,
     * org.cion.eclipse.mqtt5.common.packet.MqttProperties)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.cion.eclipse.mqtt5.client.IMqttAsyncClient#reconnect()
     */
    @Override
     ...
     *
     * @see
     * org.cion.eclipse.mqtt5.client.IMqttAsyncClient#setBufferOpts(org.eclipse.
     ...
     *
     * @see
     * org.cion.eclipse.mqtt5.client.IMqttAsyncClient#getBufferedMessageCount()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.cion.eclipse.mqtt5.client.IMqttAsyncClient#getBufferedMessage(int)
     */
    @Override
     ...
     *
     * @see
     * org.cion.eclipse.mqtt5.client.IMqttAsyncClient#deleteBufferedMessage(int)
     */
    @Override
     ...
     *
     * @see
     * org.cion.eclipse.mqtt5.client.IMqttAsyncClient#getInFlightMessageCount()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.cion.eclipse.mqtt5.client.IMqttAsyncClient#close()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.cion.eclipse.mqtt5.client.IMqttAsyncClient#close(boolean)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.cion.eclipse.mqtt5.client.IMqttAsyncClient#getDebug()
     */
    @Override
