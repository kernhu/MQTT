 ...
 */
package org.cion.eclipse.mqtt5.client.logging;
...
public class JSR47Logger implements Logger {
	 ...
	 * @param loggerID			The suffix for the loggerName (will be appeneded to org.cion.eclipse.mqtt5.client
...
//		loggerName = "org.cion.eclipse.mqtt5.client." + ((null == loggerID || 0 == loggerID.length()) ? "internal" : loggerID);
		loggerName = loggerID;
