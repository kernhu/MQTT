package org.cion.eclipse.mqtt5.common;
...
public class MqttException extends Exception {
    ...
    public String getMessage() {
        ResourceBundle bundle = ResourceBundle.getBundle("org.cion.eclipse.mqtt5.common.nls.messages");
        String message;
        try {
            message = bundle.getString(Integer.toString(reasonCode));
        } catch (MissingResourceException mre) {
            message = "Untranslated MqttException - RC: reasonCode is " + reasonCode;
        }
