...
public class MqttConnectionOptions {
     ...
     *
     * @param cleanStart Set to True to enable cleanSession
     */
     ...
     * reconnect.
     *
     * @param minDelay the minimum delay to wait before attempting to reconnect in
     *                 seconds, defaults to 1 second.
     * @param maxDelay the maximum delay to wait before attempting to reconnect in
     ...
     * </ul>
     *
     * @param requestResponseInfo The Request Response Info Flag.
     */
     ...
     *
     * @param useSubscriptionIdentifiers Whether to enable automatic assignment of subscription
     *                                   identifiers.
     */
