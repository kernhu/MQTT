...
public class MqttAndroidClient extends BroadcastReceiver implements
    ...
    private static final String SERVICE_NAME = "org.cion.eclipse.mqtt5.service.MqttService";
     ...
     * @see #subscribe(String[], int[], Object, MqttActionListener)
     */
    public IMqttToken subscribe(String topicFilter, int qos, Object userContext, MqttActionListener callback, IMqttMessageListener messageListener) throws MqttException {
     ...
     * @see #subscribe(String[], int[], Object, MqttActionListener)
     */
    public IMqttToken subscribe(String[] topicFilters, int[] qos, Object userContext, MqttActionListener callback, IMqttMessageListener[] messageListeners) throws MqttException {
    ...
    public IMqttToken unsubscribe(String[] topicFilters, Object userContext, MqttActionListener callback, MqttProperties unsubscribeProperties) throws MqttException {
        IMqttToken token = new MqttTokenAndroid(this, userContext,
                callback);
        String activityToken = storeToken(token);
        mqttService.unsubscribe(clientHandle, topicFilters, null, activityToken);
        return token;
    }
