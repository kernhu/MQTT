...
import org.cion.eclipse.mqtt5.common.packet.util.MultiByteArrayInputStream;
...
public abstract class MqttWireMessage {
     ...
     * @throws MqttException if there was an issue encoding the header
     */
     ...
     * @throws MqttException if an error occurred whilst creating the WireMessage
     */
     ...
     * @throws MqttException            If the set reserved bits do not match the specification.
     * @throws IllegalArgumentException If the message type does not exist.
     */
     ...
     * @throws MqttException thrown when an error occurs with either reading from the stream
     ...
     * @throws MqttException Thrown when an error occurs with either the encoding or writing
